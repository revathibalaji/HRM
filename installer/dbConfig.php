<?php
/**
 * FixNixHRM is a comprehensive Human Resource Management (HRM) System that captures
 * all the essential functionalities required for any enterprise.
 * Copyright (C) 2012 FixNixHRM Inc., http://www.fixRnix.in
 *
 * FixNixHRM is free software; you can redistribute it and/or modify it under the terms of
 * the GNU General Public License as published by the Free Software Foundation; either
 * version 2 of the License, or (at your option) any later version.
 *
 * FixNixHRM is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY;
...
<?php if ($_SESSION['cMethod'] == 'new') { ?>
	...
	if(!document.frmInstall.chkSameUser.checked && frm.dbOHRMUserName.value == '') {
		alert('FixNixHRM DB User-name left Empty');
...
<tr>
	...
	<td class="tdValues"><input type="text" name="dbName" value="<?php echo  isset($_SESSION['dbInfo']['dbName']) ? $_SESSION['dbInfo']['dbName'] : 'fixnixhrm_mysql'?>" tabindex="3"></td>
</tr>
...
<tr>
	<td class="tdComponent">Use the same Database User for FixNixHRM</td>
...
<?php  } ?>
<tr>
	<td class="tdComponent">FixNixHRM Database Username</td>
	<td class="tdValues"><input type="text" name="dbOHRMUserName" <?php echo isset($_POST['chkSameUser']) ? 'disabled' : '' ?> value="<?php echo  isset($_SESSION['dbInfo']['dbOHRMUserName']) ? $_SESSION['dbInfo']['dbOHRMUserName'] : 'fixnixhrm'?>" tabindex="7"> #</td>
</tr>
<tr>
	<td class="tdComponent">FixNixHRM Database User Password</td>
...
<div id="oDescription">
<font size="1"># FixNixHRM database user should have the rights to insert data into table, update data in a table, delete data in a table.</font>
</div>
