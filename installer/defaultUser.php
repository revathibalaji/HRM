...
function submitDefUserInfo() {
	...
	if(frm.OHRMAdminUserName.value.length < 5) {
		alert('FixNixHRM Admin User-name should be at least 5 char. long!');
		frm.OHRMAdminUserName.focus();
		return;
	}

	if(frm.OHRMAdminPassword.value == '') {
		alert('FixNixHRM Admin Password left Empty!');
		frm.OHRMAdminPassword.focus();
		return;
	}

	if(frm.OHRMAdminPassword.value != frm.OHRMAdminPasswordConfirm.value) {
		alert('FixNixHRM Admin Password and Confirm FixNixHRM Admin Password don\'t match!');
		frm.OHRMAdminPassword.focus();
		return;
	}
...
<div id="content">
	<h2>Step 4: Admin User Creation</h2>
        ...
        <p>After FixNixHRM is configured you will need an Administrator Account to Login into FixNixHRM. <br />
...
<tr>
	<td class="tdComponent_n">FixNixHRM Admin Username</td>
	<td class="tdValues_n"><input type="text" name="OHRMAdminUserName" value="Admin" tabindex="1"/></td>
</tr>
<tr>
	<td class="tdComponent_n">FixNixHRM Admin User Password</td>
	<td class="tdValues_n"><input type="password" name="OHRMAdminPassword" value="" tabindex="2"/></td>
</tr>
<tr>
	<td class="tdComponent_n">Confirm FixNixHRM Admin User Password</td>
