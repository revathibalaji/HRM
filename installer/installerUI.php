...
$steps = array('welcome', 'license', 'database configuration', 'system check', 'admin user creation', 'confirmation', 'Installing', 'completed');
...
<html>
<head>
<title>FixNixHRM Web Installation Wizard</title>
...
<body>
<div id="body">
  <a href="http://www.fixRnix.in"><img src="../symfony/web/themes/default/images/logo.png" alt="FixNixHRM" name="logo"  width="283" height="56" border="0" id="logo" style="margin-left: 10px;margin-bottom: 15px;" title="FixNixHRM"></a>
