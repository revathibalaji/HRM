...
<div style="display: block;" class="wrapper">
	<h2>Step 7: Completed</h2>
	 <p>You have successfully installed FixNixHRM.</p>
...
*	            <li><span>Receive FixNixHRM newsletter and other useful updates</span></li>
*	        </ul>
*   </div>
*/
?>
		...
		if($reqAccept) { ?>
	        <p>Registration information was collected, and Succesfully sent to fixRnix.in</p>
        <?php } else { ?>
    	    <p class="error">Registration information was collected, but NOT sent to fixRnix.in, please click Retry to try again, or click Skip to proceed and login into FixNixHRM</p>
            <?php }
	}
...
<?php   if(!isset($reqAccept)) { ?>
        ...
        <div>
	        <input name="button" type="button" onclick="noREG();" value="Login into FixNixHRM!" tabindex="9"/>
<!--	        <input name="btnRegister" type="button" onclick="regInfo();" value="Register" tabindex="8"/>-->
        </div>
        <?php } elseif($reqAccept) {?>
        <input name="button" type="button" onclick="login();" value="Login to FixNixHRM" tabindex="10"/>
        <?php } else { ?>
        <input name="button" type="button" onclick="noREG();" value="Login to FixNixHRM" tabindex="11"/>
